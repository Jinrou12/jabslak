      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          {isArrived && isUncheckingThis && (
            <div className="flex items-center gap-1 text-[10px] text-rose-300 bg-rose-500/20 border border-rose-500/40 px-1.5 py-0.5 rounded-md mt-1 w-fit font-kantumruy font-bold animate-pulse">
