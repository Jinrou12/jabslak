...
export const INITIAL_TEMPLE_LOCATIONS = [
  ...
  { id: "៧",  name: "ព្រះវិហារ",                     x: 37.47, y: 54.24, type: "building", pos: "A", category: "🏢 ក្រុមអគារ និង កុដិ" },
  ...
  { id: "១០", name: "ពុទ្ឌកបឋមសិក្សាកម្រងហ៊ុនណេង", x: 58.49, y: 44.51, type: "building", pos: "B", category: "🏢 ក្រុមអគារ និង កុដិ" },
  { id: "១១", name: "កុដិយាយតា",                    x: 43.58, y: 26.71, type: "building", pos: "L", category: "🏢 ក្រុមអគារ និង កុដិ" },
  { id: "១២", name: "ប៉ុស្តវិទ្យុ",                 x: 54.14, y: 21.64, type: "building", pos: "L", category: "🏢 ក្រុមអគារ និង កុដិ" },
  ...
  { id: "១៦", name: "ចេតីយឧកញ៉ា ចាយ ស៊ាងអ៊ី",              x: 53.21, y: 78.57, type: "building", pos: "B", category: "🏢 ក្រុមអគារ និង កុដិ" },
  { id: "A",  name: "ក្លោងទ្វារទី១",               x: 76.60, y: 6.31,  type: "gate",     pos: "L", category: "⛩️ ក្រុមខ្លោងទ្វារវត្ត" },
  { id: "B",  name: "ក្លោងទ្វារទី២",               x: 28.78, y: 19.25, type: "gate",     pos: "B", category: "⛩️ ក្រុមខ្លោងទ្វារវត្ត" },
  { id: "C",  name: "ក្លោងទ្វារទី៣",               x: 93.89, y: 55.49, type: "gate",     pos: "L", category: "⛩️ ក្រុមខ្លោងទ្វារវត្ត" },
  { id: "D",  name: "ក្លោងទ្វារទី៤",               x: 73.08, y: 70.70, type: "gate",     pos: "L", category: "⛩️ ក្រុមខ្លោងទ្វារវត្ត" },
  { id: "E",  name: "ក្លោងទ្វារទី៥",               x: 4.24,  y: 46.79, type: "gate",     pos: "R", category: "⛩️ ក្រុមខ្លោងទ្វារវត្ត" }
];
...
const STORAGE_KEY = 'TEMPLE_MAP_LOCATIONS_PERSIST';
...
export function getSavedTempleLocations() {
  try {
    ...
    console.error('Error loading saved temple locations:', e);
  }

  return INITIAL_TEMPLE_LOCATIONS.map((loc) => ({
    ...loc,
    x1: loc.x,
    y1: loc.y,
    x2: loc.x,
...
export function saveTempleLocations(locations) {
  try {
    ...
    console.error('Error saving temple locations:', e);
  }
}

/**
 * Reset to initial 21 temple locations
 */
export function resetTempleLocations() {
  try {
    localStorage.removeItem(STORAGE_KEY);
  } catch (e) {}
  return getSavedTempleLocations();
}
